...
class TestSalutationService:
    ...
    def test_say_hi_when_greetings_file_exists(self):
        salutation_service = SalutationService(
            os.path.join(DIR_PATH, "greetings_test.csv"), os.path.join(DIR_PATH, "farewells_test.csv")
        )
    ...
    def test_say_hi_when_greetings_file_does_not_exist(self):
        salutation_service = SalutationService(
            os.path.join(DIR_PATH, "does_not_exist.csv"), os.path.join(DIR_PATH, "farewells_test.csv")
        )
    ...
    def test_say_hi_when_greetings_file_is_empty(self):
        salutation_service = SalutationService(
            os.path.join(DIR_PATH, "empty_file.csv"), os.path.join(DIR_PATH, "farewells_test.csv")
        )
    ...
    def test_say_good_bye_when_farewells_file_does_not_exist(self):
        salutation_service = SalutationService(
            os.path.join(DIR_PATH, "does_not_exist.csv"), os.path.join(DIR_PATH, "does_not_exist.csv")
        )
    ...
    def test_say_good_bye_when_farewells_file_is_empty(self):
        salutation_service = SalutationService(
            os.path.join(DIR_PATH, "greetings_test.csv"), os.path.join(DIR_PATH, "empty_file.csv")
        )
